...
if(direction.lower() == "right"):
    ...
    choice2 = input(f"You've come to a lake. There is an island in the middle of the lake.\n\tType \"wait\" to wait for a boat. Type \"swim\" to swim across.\n")

    if (choice2.lower() == "swim"):
        print(f"You get attacked by an angry trout. Game Over.")
    elif (choice2.lower() == "wait"):
        choice3 = input(f"You arrive at the island unharmed. There is a house with 3 doors.\n\tOne red, one yellow and one blue. Which colour do you choose?\n")
